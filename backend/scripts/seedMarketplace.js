...
const NFT_101_DATA = [
  {
    ...
    contentBlocks: [
      ...
      { type: "text", value: "The concept of ownership in the digital world has always been problematic because digital files can be copied infinitely. NFTs solve this by providing verifiable proof of ownership stored on a decentralised ledger. This means that even if a file is duplicated, only one wallet holds the authentic token. As a result, NFTs introduce scarcity and authenticity into digital environments." },
      ...
      { type: "text", value: "NFTs are significant because they shift control from centralised platforms to individual users. Players and creators can truly own their digital assets and decide how they are used. This opens up new opportunities for monetisation, including trading, renting, or licensing assets." },
