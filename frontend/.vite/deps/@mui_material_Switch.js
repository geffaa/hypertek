import {
  ...
  memoize,
  require_jsx_runtime
} from "./chunk-CJGQYTEG.js";
import {
  require_prop_types
} from "./chunk-FWNK54VO.js";
import {
  require_react_dom
} from "./chunk-W2VP353T.js";
import {
  require_react
...
true ? Grid.propTypes = {
   ...
   */
  offset: import_prop_types16.default.oneOfType([import_prop_types16.default.string, import_prop_types16.default.number, import_prop_types16.default.arrayOf(import_prop_types16.default.oneOfType([import_prop_types16.default.string, import_prop_types16.default.number])), import_prop_types16.default.object]),
  /**
   ...
   */
  size: import_prop_types16.default.oneOfType([import_prop_types16.default.string, import_prop_types16.default.bool, import_prop_types16.default.number, import_prop_types16.default.arrayOf(import_prop_types16.default.oneOfType([import_prop_types16.default.string, import_prop_types16.default.bool, import_prop_types16.default.number])), import_prop_types16.default.object]),
  /**
...
`;
var TouchRipple = React47.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const startCommit = React47.useCallback((params) => {
    ...
    setRipples((oldRipples) => [...oldRipples, (0, import_jsx_runtime19.jsx)(TouchRippleRipple, {
      classes: {
  ...
  const start = React47.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  return (0, import_jsx_runtime19.jsx)(TouchRippleRoot, {
    className: clsx_default(touchRippleClasses_default.root, classes.root, className),
    ref: container,
    ...other,
    children: (0, import_jsx_runtime19.jsx)(TransitionGroup_default, {
      component: null,
      exit: true,
      children: ripples
    })
...
var ButtonBase = React48.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  return (0, import_jsx_runtime20.jsxs)(ButtonBaseRoot, {
    as: ComponentProp,
    className: clsx_default(classes.root, className),
    ownerState,
    onBlur: handleBlur,
    ...
    ...buttonProps,
    ...other,
    children: [children2, enableTouchRipple ? (0, import_jsx_runtime20.jsx)(TouchRipple_default, {
      ref: handleRippleRef,
      center: centerRipple,
      ...TouchRippleProps
    }) : null]
...
var SwitchBase = React49.forwardRef(function SwitchBase2(props, ref) {
  ...
  return (0, import_jsx_runtime21.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [(0, import_jsx_runtime21.jsx)(InputSlot, {
      ...inputSlotProps
...
var Switch = React50.forwardRef(function Switch2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiSwitch"
  });
  ...
  const icon = (0, import_jsx_runtime22.jsx)(ThumbSlot, {
    ...thumbSlotProps
  });
  ...
  return (0, import_jsx_runtime22.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [(0, import_jsx_runtime22.jsx)(SwitchSwitchBase, {
      type: "checkbox",
      icon,
      checkedIcon: icon,
      ref,
    ...
    }), (0, import_jsx_runtime22.jsx)(TrackSlot, {
      ...trackSlotProps
    })]
  });
});
true ? Switch.propTypes = {
  ...
  slotProps: import_prop_types32.default.shape({
    ...
    switchBase: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.object]),
  ...
  slots: import_prop_types32.default.shape({
    ...
    switchBase: import_prop_types32.default.elementType,
