...
function Support() {
  ...
  return (
    <div className="flex bg-black ">
      {/* Center Chat */}
      <div className="flex flex-col w-[760px] h-[450px] px-4">
        ...
        {/* Input */}
        <div className="mt-4 flex flex-col rounded-xl justify-between bg-gray-50 w-full max-w-[760px] border border-[#EDEDED] p-3">
          <input
            type="text"
            value={text}
            ...
            className="w-full text-black font-inter font-medium text-[12px] leading-5 rounded px-2 py-1 outline-none bg-transparent"
          />
          <div className="w-full flex justify-end items-center mt-2">
            <button
              onClick={handleSendMessage}
              className="cursor-pointer flex items-center gap-2 justify-center w-[70px] h-[28px] bg-[#1D7AD6] rounded-[6px]"
            >
