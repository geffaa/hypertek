  ...
  return (
    <div className="flex flex-col min-h-screen bg-black overflow-hidden relative">
      ...
      <div className="relative z-50 w-full px-4 md:px-8">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-10 mt-20 md:mt-20">
          {/* Left Side: Image Upload */}
          <div
            className="flex items-center justify-center cursor-pointer backdrop-blur-sm bg-white/5 border border-white/30 rounded-md relative w-full max-w-[456px] h-[300px] md:h-[440px] mx-auto lg:mx-0"
            style={{
              borderStyle: "dashed",
          ...
          <div className="relative z-50 rounded-lg p-0 md:p-6 w-full max-w-[495px] mx-auto lg:mx-0 flex flex-col gap-6">
            <h2 className="text-white text-[22px] md:text-2xl font-semibold">Edit your own NFA's</h2>
            <p className="text-white/70 text-[16px] md:text-base leading-relaxed">
            ...
            <div className="w-full h-auto flex flex-col gap-[14px] mt-4">
              <label
                htmlFor="type"
              ...
              <select
                ...
                className="w-full h-10 px-3 rounded-md bg-white/10 text-white border border-gray-600 focus:outline-none focus:border-blue-500 focus:bg-gray-700 transition-colors"
              >
            ...
            {/* Earnings */}
            <span className="text-white text-xl font-semibold mt-4">Earnings</span>
            <div className="flex flex-col sm:flex-row gap-6">
              {/* Creator Fee */}
              <div className="flex flex-col gap-2 w-full sm:w-1/2">
                <label className="text-white text-base font-normal">Creator Fee</label>
                <div className="flex items-center h-12 px-3 border border-gray-600 rounded-md bg-white/10 focus-within:border-blue-500 focus-within:bg-white/15 transition">
                  <input
                    type="text"
                    value={formData.royaltyPercent}
                    onChange={(e) => setFormData({ ...formData, royaltyPercent: e.target.value })}
                    className="w-full bg-transparent border-none outline-none text-white text-[18px]"
                  />
        ...
        {/* Buttons */}
        <div className="flex flex-col sm:flex-row justify-end gap-4 sm:gap-6 mt-16 px-4 md:mx-8">
          <button className="border border-white text-white hover:bg-white/10 transition-colors w-full sm:w-32 h-10 rounded-md font-medium bg-transparent">
            Cancel
          </button>
          <button onClick={handleUpdate} className="bg-blue-800 hover:bg-blue-700 transition-colors w-full sm:w-48 h-10 rounded-md font-medium text-white border-none">
            Publish Contract
          </button>
        </div>
      </div>
