  ...
  return (
    <div className="min-h-screen px-4 md:px-8 py-8">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-white font-semibold text-xl">Manage Items</h1>
          <p className="text-white/40 text-xs mt-0.5">
            Collection: <span className="text-white/60 font-medium">{parentName || parentId}</span>
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 text-xs mb-8">
        <span className="flex items-center gap-1.5">
          ...
          <span className="text-white/40">Create Collection</span>
        </span>
      ...
      <div className="flex flex-col xl:flex-row gap-10">
        ...
        <div className="xl:w-[380px] flex-shrink-0">
          ...
          {loadingItems ? (
            ...
            <div className="rounded-xl border border-white/5 bg-white/3 p-6 text-center">
              ...
              <p className="text-white/20 text-xs mt-1">Add your first item using the form →</p>
            </div>
          ) : (
          ...
          {existingItems.length > 0 && (
            <div className="mt-5 p-4 rounded-xl border border-blue-500/15 bg-blue-500/5">
              <p className="text-blue-300/80 text-xs font-medium">{existingItems.length} item{existingItems.length > 1 ? "s" : ""} added</p>
              <p className="text-white/40 text-xs mt-1 leading-relaxed">
                Items are saved in your collection. To list them on-chain, go to your <span className="text-white/60">Profile</span> and click "List for Sale".
              </p>
              <Link to="/Profile">
        ...
        <div className="flex-1 max-w-[560px]">
          <h2 className="text-white/70 text-sm font-semibold uppercase tracking-wider mb-4">Add New Item</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            ...
            <div className="flex-1 flex flex-col gap-4">
              <div>
                ...
                <input type="text" placeholder="e.g. Hyperion Skin #1"
