...
const PILLARS = [
  {
    ...
    desc: "On-chain NFT assets, real ownership, and a transparent marketplace built on Base.",
  },
  {
    Icon: Gem,
    accent: "#fbbf24",
    ...
    title: "True Asset Value",
    desc: "Every in-game item is a tradeable NFT. Play, earn, and own your progress.",
  },
  {
    Icon: Network,
    accent: "#818cf8",
    ...
    desc: "Commission splits and buyback mechanics designed to reward every participant.",
  },
  {
    Icon: Rocket,
    accent: "#4ade80",
    ...
    title: "Get Involved",
    desc: "From early investors to active players — multiple pathways to join the Hyper Tek universe.",
  },
];
    ...
    <div className="relative text-white min-h-screen flex flex-col" style={{ background: "#060614" }}>
      ...
      <main className="relative z-10 flex-1 w-full max-w-[1480px] mx-auto px-6 md:px-14 xl:px-18 2xl:px-20 flex flex-col justify-center py-10">
          ...
          <div className="flex items-center gap-8 md:gap-12">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-white/80 text-[13px] md:text-[14px] leading-snug">
                ...
                <span className="text-white/55">Building the future of Web3 gaming.</span>
              </p>
            </div>
          </div>
          <LanguageSwitcher />
        ...
        >
          ...
          <div className="relative z-10 px-8 md:px-14 lg:px-16 py-12 md:py-14">
            ...
            >
              Reimagining Gaming.<br />
              <span style={{ color: "#38bdf8" }}>Powered by Web3.</span>
            </motion.h2>
            ...
            >
              Hyper Tek 100 is a next-generation gaming ecosystem where every asset is real, every trade is on-chain,
              and every player is a true stakeholder. Three interconnected games. One shared economy. Built for the future.
            </motion.p>

            {/* Pillars grid */}
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
              {PILLARS.map((pillar, i) => {
                const { Icon, accent, glow, border, title, desc } = pillar;
                return (
                <motion.div
                  key={title}
                ...
                >
                  ...
                  <h4 className="text-white font-bold text-sm mb-1.5" style={{ fontFamily: "Orbitron, sans-serif", fontSize: 11, letterSpacing: "0.08em" }}>
                    {title}
                  </h4>
      ...
      <AnimatePresence>
        {showFullAbout && (
          ...
          >
            {/* Fixed top bar for close button */}
            <div
