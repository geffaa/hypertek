    ...
    <div className="flex flex-col min-h-screen bg-black overflow-hidden">
      ...
      <div className="relative z-50">
        <div className="flex gap-10 mt-20 mx-8">
            ...
            {previewImage ? (
              ...
              <div className="flex flex-col items-center justify-center gap-2">
                ...
                <div className="relative w-[240px] h-[49px] flex items-center justify-center rounded-md">
                  <label htmlFor="file-upload" className="text-center text-white cursor-pointer">
          ...
          <div className="relative z-50 rounded-lg p-6 w-[456px] flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className={`flex items-center gap-2 px-2 h-12 border rounded-md bg-white/10 focus-within:bg-white/15 transition ${errors.chain ? 'border-red-500' : 'border-gray-600'}`}>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    // Clear error when user starts typing
                    if (errors.chain) setErrors(prev => ({ ...prev, chain: "" }));
                  }}
                  placeholder="USDT"
                  className="w-full bg-transparent outline-none text-white placeholder-white/60"
                />
              </div>
              {errors.chain && <p className="text-red-500 text-sm mt-1">{errors.chain}</p>}
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end gap-6 mt-16 mx-8">
          <button 
            className="border border-white text-white hover:bg-white/10 transition-colors w-32 h-10 rounded-md font-medium"
