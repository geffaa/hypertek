  ...
  return (
    <section className="w-full z-10 flex justify-center items-start px-0 py-10 md:py-12 relative">
      ...
      <div
        ...
        className="absolute -z-10 w-[120px] h-[120px] md:w-[220px] md:h-[220px] rounded-full from-blue-500/50 via-blue-800/60 to-white/0 blur-[60px] md:blur-[90px] shadow-[0_0_30px_15px_rgba(59,130,246,0.45),0_0_80px_40px_rgba(59,130,246,0.3),0_0_160px_80px_rgba(59,130,246,0.15)]"
      />
      <div
        style={{ bottom: "90px", right: "100px" }}
        className="absolute -z-10 w-[120px] h-[120px] md:w-[220px] md:h-[220px] rounded-full bg-gradient-to-b from-blue-500/50 via-blue-600/60 to-white/20 blur-[60px] md:blur-[100px] shadow-[0_0_30px_15px_rgba(59,130,246,0.45),0_0_80px_40px_rgba(59,130,246,0.3),0_0_160px_80px_rgba(59,130,246,0.15)]"
      />
          ...
          {news[3] && (
            ...
            >
              ...
              <div className="text-white px-3 py-2">
                <h3 className="text-white text-lg sm:text-xl font-bold uppercase font-goldman">
                  {news[0].heading.length > 40 ? news[0].heading.slice(0, 40) + "..." : news[0].heading}
                </h3>
              </div>
            </div>
          )}
