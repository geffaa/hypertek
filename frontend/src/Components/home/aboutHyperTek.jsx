          ...
          <div className="hidden lg:relative lg:bg-[#B0BDE4] lg:flex items-center justify-center w-full lg:w-[520px] h-[300px] sm:h-[400px] lg:h-[520px]  ">
            ...
            <div className="hidden lg:flex flex-col items-center absolute left-6 top-1/2 -translate-y-1/2 z-10">
              ...
              <div className="flex items-center justify-center my-3 [writing-mode:vertical-lr] rotate-180">
                <h2 className="font-inter outline-text font-semibold text-[30px] uppercase tracking-widest text-white">
                  HYPER TEK 100
                </h2>
              </div>
              <div className="w-[2px] h-20 bg-white"></div> 
            ...
            <img
              src={LeftImage}
              alt="Hyper Tek Main"
              className="w-[546px] max-w-[400px] sm:max-w-[450px] lg:max-w-[510px] h-[220px] sm:h-[320px] lg:h-[414px] object-cover lg:ml-[10rem]"
            />
          </div>
