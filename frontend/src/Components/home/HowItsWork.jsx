...
function HowItsWork() {
  ...
  return (
    <section className="flex flex-col lg:flex-row gap-16 px-11 sm:px-8 md:px-16 py-16 lg:py-20 items-start justify-center relative z-10">
      ...
      {/* Left side */}
      <div className="w-full lg:w-[355px] flex flex-col my-auto gap-6 text-white text-center lg:text-left">
        <h2
      ...
      {/* Right side */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-14 w-full lg:w-[716px]">
