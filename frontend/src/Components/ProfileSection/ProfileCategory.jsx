  ...
  return (
    <div className="relative w-full bg-black min-h-screen">
      ...
      <div className="relative">
        ...
        {/* ================= PROFILE SECTION ================= */}
        <div className="relative z-10 pt-20 sm:pt-32 lg:pt-40 pb-10">
          <div className="max-w-7xl mx-auto px-4 flex items-center gap-4 sm:gap-6">
            <div className="w-20 h-20 sm:w-28 sm:h-28 lg:w-36 lg:h-36 rounded-full bg-gradient-to-br from-white/20 to-white/5 p-1 flex items-center justify-center">
