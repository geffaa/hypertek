        ...
        <div className="w-full py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="hidden md:flex items-center space-x-6 font-semibold text-white relative ml-8">
              ...
              <Link to="/news" className="hover:text-blue-300 transition-colors duration-200">
                News
              </Link>
            ...
            {isLoggedIn ? (
              <div className="hidden md:flex items-center space-x-4">
                <div className="flex items-center rounded-[10px] bg-[#8C9ED8] p-1 min-w-[200px]">
                  <img src={SearchImg} alt="Search" className="w-8 h-8 rounded-md" />
                  <input 
                    type="text" 
                    placeholder="Search..." 
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-[#001554D9] text-white px-4 py-4 flex flex-col space-y-3 border-t border-white/20">
            ...
            >
              ...
              <ChevronDown className={`h-4 w-4 transition-transform duration-200 ${socialOpen ? 'rotate-180' : ''}`} />
            </button>
            {socialOpen && (
              <div className="pl-4 flex flex-col space-y-2 border-l-2 border-white/30 ml-2">
                <a 
            ...
            {isLoggedIn ? (
              <div className="flex items-center space-x-2 mt-4 w-full">
                <div className="flex items-center bg-[#8C9ED8] rounded-[10px] p-2 w-full">
                  <img src={SearchImg} alt="Search" className="w-8 h-8 rounded-md" />
                  <input 
                    type="text" 
                    placeholder="Search..." 
                ...
                <img src={ProfileImg} alt="Profile" className="w-10 h-10 rounded-md hover:scale-105 transition-transform duration-200" />
              </div>
            ) : (
