...
import { BACKEND_BASE_URL, PURCHASES_LOCKED, getImageUrl } from "../../Config";
...
function Buy1() {
  ...
  const getButtonAction = () => {
    ...
    if (itemStatus.isListed || itemStatus.isPlatformOwned) {
      if (PURCHASES_LOCKED) {
        return disabled(`🔒 ${t("marketplace.launchLock.purchasesNote", "Purchases open at official launch")}`);
      }
