  ...
  return createPortal(
    ...
    >
      <style>{`
        ...
        @keyframes ovlVideoShimmer { 0%,100%{background-position:0% 50%} 50%{background-position:100% 50%} }
        @keyframes ovlVideoSpin { to { transform: rotate(360deg) } }
        @keyframes ovlCtrlFadeIn { from{opacity:0;transform:translateY(6px)} to{opacity:1;transform:translateY(0)} }
      `}</style>
      <div
          ...
          {videoLoaded && isBuffering && (
            <div style={{
              ...
              <div style={{ width: 36, height: 36, borderRadius: "50%",
                border: "3px solid rgba(248,113,113,0.2)", borderTopColor: "rgba(248,113,113,0.9)",
                animation: "ovlVideoSpin 0.8s linear infinite",
              }} />
              <div style={{ fontFamily: "Orbitron,sans-serif", fontSize: "clamp(7px,0.75vw,10px)",
                color: "rgba(248,113,113,0.85)", letterSpacing: "0.16em",
              }}>BUFFERING...</div>
            </div>
          )}
          <video
          ...
          {videoLoaded && (
            <div
              ...
              style={{
                ...
                animation: "ovlCtrlFadeIn 0.3s ease both",
              }}
            >
              <button
                style={{
              ...
              <div style={{
                ...
                color: isBuffering ? "rgba(248,197,94,0.8)" : isPlaying ? "rgba(248,113,113,0.7)" : "rgba(248,113,113,0.5)",
