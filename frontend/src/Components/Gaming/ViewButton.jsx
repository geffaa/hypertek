    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          right:    "3.5%",
          zIndex:   35,
          width:    inGame ? "auto" : "11vh",
          height:   inGame ? "auto" : "11vh",
      ...
      >
        ...
        {inGame ? (
          ...
          <>
            <span style={{
              fontSize: "clamp(16px, 2.2vh, 24px)", color: "#00D4FF",
              lineHeight: 1, textShadow: "0 0 12px rgba(0,212,255,0.8)", zIndex: 1,
            }}>{view.icon}</span>
            <span style={{
              fontFamily: "Orbitron, sans-serif", fontSize: "clamp(5px, 0.55vw, 7px)",
              fontWeight: "bold", letterSpacing: "0.1em", color: "#00D4FF",
              textShadow: "0 0 6px rgba(0,212,255,0.6)", zIndex: 1,
            }}>VIEW</span>
            <span style={{
              fontFamily: "Orbitron, sans-serif", fontSize: "clamp(4px, 0.4vw, 5.5px)",
              letterSpacing: "0.08em", color: "rgba(0,212,255,0.5)", zIndex: 1,
            }}>{view.sub}</span>
          </>
        )}
      </div>
