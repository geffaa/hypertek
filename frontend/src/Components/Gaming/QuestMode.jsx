...
const LOCATIONS = [
  // ── Left cluster ──────────────────────────────────────────
  { id:"sd",    name:"ZETA-51-M2-GM09",    type:"Supply Depot",        coords:"T13·L11", atm:"ARTIFICIAL", hazard:"LOW",    left:"28%",   top:"29%",                                          desc:"Primary logistics hub for the western frontier. Maintains emergency ration reserves." },
  { id:"res",   name:"AGG4-ST04-GM09",     type:"Research Station",    coords:"T14·L06", atm:"ARTIFICIAL", hazard:"LOW",    left:"13.1%", top:"22%",   labelBelow:true, labelShift:{x:-10,y:0}, desc:"Xenobiology and deep-space materials lab. Houses 40 resident scientists." },
  ...
  { id:"sci",   name:"TP537-RSS-GM09",     type:"Science Outpost",     coords:"T04·L13", atm:"VACUUM",     hazard:"MEDIUM", left:"17.5%", top:"63%",                                          desc:"Research station studying gravitational anomalies near the galactic core boundary." },
  { id:"comm",  name:"ZIR-31-6NV-GM09",    type:"Communication Array", coords:"T03·L08", atm:"VACUUM",     hazard:"LOW",    left:"29.5%", top:"66%",                                          desc:"Quantum-entanglement communication node. Zero-lag interstellar messaging." },
  { id:"relay", name:"REF311-F/O-GM09",    type:"Deep Space Relay",    coords:"T03·L11", atm:"VACUUM",     hazard:"LOW",    left:"23%",   top:"77%",                                          desc:"Automated relay node. Maintains network connectivity for outer ring settlements." },
  { id:"echo",  name:"RESa56-F\\37-GM09",  type:"Echo Station",        coords:"T02·L15", atm:"VACUUM",     hazard:"LOW",    left:"10%",   top:"74%",                                          desc:"Long-range communication relay. Signal strength: 99.7%. Uptime: 14.2 years." },
  // ── Center ────────────────────────────────────────────────
  ...
  { id:"expl",  name:"HIc3-GM09",          type:"Exploration Outpost", coords:"T08·R06", atm:"VACUUM",     hazard:"LOW",    left:"73.5%", top:"41%",                                          desc:"Forward scout base for unmapped regions. Last transmission: 3.2 standard days ago." },
  ...
  { id:"gas",   name:"OP27a-GM09",         type:"Gas Extraction",      coords:"T05·R05", atm:"TOXIC",      hazard:"HIGH",   left:"67.5%", top:"30%",                                          desc:"Atmospheric gas harvesting from a dense nebula pocket. High radiation environment." },
  { id:"ice",   name:"SR5c-COM-GM09",      type:"Ice Harvesting",      coords:"T03·R07", atm:"VACUUM",     hazard:"LOW",    left:"64.5%", top:"35%",                                          desc:"Cryo-comet resource extraction. Primary water source for eastern stations." },
