...
const LOCATIONS = [
  ...
  { id:"orb",   name:"TXC-44P",      type:"Orbital Lab",         coords:"T14·R07", atm:"ARTIFICIAL", hazard:"MEDIUM", left:"22.5%", top:"18.5%", labelBelow:true, labelShift:{x:22,y:0}, desc:"Zero-gravity materials research. Studies exotic matter behavior under void conditions." },
