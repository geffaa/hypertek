...
function useEventCallback(fn) {
  const ref = React30.useRef(fn);
  useEnhancedEffect_default(() => {
    ref.current = fn;
  });
  return React30.useRef((...args) => (
...
function useLazyRef(init, initArg) {
  const ref = React31.useRef(UNINITIALIZED);
...
var LazyRipple = class _LazyRipple {
  ...
  static use() {
    ...
    const [shouldMount, setShouldMount] = React32.useState(false);
    ripple.shouldMount = shouldMount;
    ripple.setShouldMount = setShouldMount;
    React32.useEffect(ripple.mountEffect, [shouldMount]);
    return ripple;
  }
  constructor() {
    this.ref = {
...
var TouchRipple = React41.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const start = React41.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
...
var SwitchBase = React43.forwardRef(function SwitchBase2(props, ref) {
  const {
    autoFocus,
    checked: checkedProp,
    checkedIcon,
...
var Switch = React44.forwardRef(function Switch2(inProps, ref) {
  const props = useDefaultProps2({
    props: inProps,
    name: "MuiSwitch"
  });
